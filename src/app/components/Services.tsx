...
const services = [
  {
    ...
    description:
      "Handcrafted pastries, breads, and desserts made daily with locally-sourced ingredients and traditional techniques.",
    icon: "🥐",
    features: [
  ...
  },
  {
    ...
    description:
      "Expertly crafted coffee beverages using ethically sourced beans roasted to perfection in small batches.",
    icon: "☕",
    features: [
  ...
  },
  {
    ...
    description:
      "Elevate your special occasions with our custom catering packages and private event hosting options.",
    icon: "🎉",
    features: [
      ...
      <div className="w-16 h-20 bg-gradient-to-b from-pink-200 via-yellow-200 to-orange-200 relative mx-auto">
        <div
          style={{
            ...
            background:
              "linear-gradient(to bottom, rgb(252, 231, 243), rgb(254, 240, 138), rgb(254, 215, 170))",
          }}
    ...
    >
      ...
      <div className="container mx-auto relative">
        ...
        >
          ...
          <h2
            className={`${playfair.className} text-5xl md:text-6xl font-bold mb-6 text-[#5C4B36]`}
          >
            Our Services
          </h2>
              ...
              >
                ...
                <div className="p-8 relative">
                  ...
                  <div className="flex items-center mb-4">
                    ...
                    />
                    <h3
                      className={`${playfair.className} text-2xl font-semibold text-[#5C4B36]`}
                    >
                      {service.title}
                    </h3>
                  </div>
                  ...
                  <p
                    className={`${cormorant.className} mb-6 text-[#6b5c48] text-lg leading-relaxed`}
                  >
                    {service.description}
                  </p>
        ...
        <motion.div
          ...
          style={{
            background:
              "linear-gradient(135deg, rgba(140, 109, 77, 0.08), rgba(140, 109, 77, 0.15), rgba(140, 109, 77, 0.08))",
            padding: "4rem 2rem",
            borderRadius: "2rem",
        ...
        >
          ...
          <h3
            className={`${playfair.className} text-4xl font-semibold mb-6 text-[#5C4B36]`}
          >
            Have a special request?
          </h3>

          <p
            className={`${cormorant.className} mb-10 max-w-2xl mx-auto text-[#6b5c48] text-xl leading-relaxed`}
          >
            We love creating custom experiences for our patrons. Let us know how
            we can make your visit or event truly special.
          </p>
          ...
          >
            <svg width="100" height="100" viewBox="0 0 24 24" fill="none">
              ...
              />
              <path
                d="M18 8H22V10C22 11.1046 21.1046 12 20 12C18.8954 12 18 11.1046 18 10V8Z"
                stroke="#76624d"
                strokeWidth="2"
              />
              <path
