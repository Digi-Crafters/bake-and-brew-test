    ...
    <header
      className={`sticky top-0 z-50 w-full transition-all duration-500 ${
        isScrolled
          ...
          : "bg-gradient-to-b from-[#5d4037] to-[#4e342e] py-3"
      }`}
    >
      ...
      <div className="max-w-6xl mx-auto flex items-center justify-between">
        <h2
          ...
          } text-2xl sm:text-3xl md:text-4xl relative transition-colors duration-500 ${
            isScrolled ? "text-[#5d4037]" : "text-amber-50"
          }`}
          style={{
        ...
        >
          Bean and Brew
          {/* <span
            className={`absolute -bottom-2 left-0 right-0 h-0.5 rounded-full transition-all duration-500 ${
              isScrolled
        ...
        <nav className="hidden md:flex gap-4 md:gap-6">
          {navItems.map((item, index) => (
            <button
              ...
              className={`font-medium transition-all duration-300 flex items-center py-2 relative group ${
                isScrolled
                  ? "text-[#5d4037] hover:text-amber-600"
            ...
            >
              ...
              <span
                className={`absolute bottom-0 left-0 h-0.5 bg-amber-400 transition-all duration-300 rounded-full ${
                  activeHover === item.label ? "w-full" : "w-0"
                }`}
              ></span>
        ...
        >
          <div className="w-6 h-6 flex flex-col justify-center space-y-1">
            <span
              ...
              } ${isScrolled ? "bg-[#5d4037]" : "bg-amber-50"}`}
            ></span>
            <span
